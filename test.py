...
tab_request = [
                ...
                ["Avataricard01", 'danish', 'rome', 44, 1],
                ["Avataricard01", 'danish', 'sofia', 44, 0],

                ["Avataricard01", 'dutch', 'rome', 44, 0],
                ["Avataricard01", 'dutch', 'sofia', 44, 1],
                ...
                ["Avataricard01", 'maltese', 'amsterdam', 20, 0],
                ["Avataricard01", 'maltese', 'copenhagen', 20, 1],

                ["Avataricard01", 'polish', 'madrid', 20, 0],
                ["Avataricard01", 'polish', 'paris', 20, 1],

                ["Avataricard01", 'portuguese', 'rome', 20, 0],
                ["Avataricard01", 'portuguese', 'valletta', 20, 1],

                ["Avataricard01", 'romanian', 'vienna', 20, 0],
